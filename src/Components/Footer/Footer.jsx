  ...
  return (
    <footer className="footer p-10 bg-base-300 text-base-content mt-16">
      ...
      <img
        ...
        />
    <p className="font-semibold text-xl">Kids World</p>
    <p>Copyright © 2023 - All right reserved by Kids World</p>
  </div> 
      <div>
      ...
      <div>
        ...
        <a className="link link-hover">+880 171-000-0088</a>
        <a className="link link-hover">12/3 - Dhanmondi, Dhaka</a>
